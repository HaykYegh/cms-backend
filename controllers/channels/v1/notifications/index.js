...
router.get('/users/count', async (req, res) => {
  ...
  const channelId = req.query.serviceId ? null : req.channelId;
  // res.send({ customerId, platforms, countries, startsWith, channelId, serviceId });
  try {
...
router.post('/users', async (req, res) => {
  ...
  const prefix = req.admin.customer.prefix;
  const startsWith = prefix + (req.query.startsWith || '');
  const channelId = req.body.serviceId ? null : req.channelId;
